...
<body>
    ...
    <div class="div">
        <div class="div-2">
            <img loading="lazy" srcset="img/yess/awalYESS.png" class="img" />
            <div class="div-3">
                <img loading="lazy" srcset="img/yess/logoYESS.png" class="img-2" />
        ...
        <div class="div-18">
            <img loading="lazy" srcset="img/yess/jadwalYESS.png" class="img" />
            <div class="div-19">
                It’s an honor that you would choose to spend an hour of your weekend with
                us!
            </div>
            <div class="div-20">JOIN US FOR YESS</div>
            <a href="/jadwal" class="div-201"
                style="border: 1px solid #fff; margin-top: 10px; font-size: 18px; z-index: 10; padding: 8px 20px; text-decoration: none; color: #fff; font-family: 'Montserrat';">
                Jadwal Ibadah
            </a>
        </div>
    </div>
    ...
    <div class="container-fluid" style="margin-top: 20px; overflow-x: hidden; margin-bottom: 20px;">
        <div class="row" style="margin-right: -15px; margin-left: -15px;">
            ...
            <div class="col-sm-6"
                ...
                <img src="img/yess/barengYESS.png" alt=""
                    style="width: 100%; height: 50vh; object-fit: cover;">
            </div>
        </div>
    </div>
    ...
    <div class="divupe-2 container-fluid" style="background-color: #000;">
        ...
        <div class="row mt-2">
            <div class="col-4">
                <img loading="lazy" srcset="img/yess/eventYESS.png" class="img-2 m-4" />
            </div>
            <div class="col m-4 mt-2">
                <div class="divupe-4">YESS Conference</div>
                <div class="divupe-5">xxxx II || 18.00 WIB || 19 Agustus 2023</div>
                <div class="divupe-6">
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolor saepe rem voluptates quibusdam eius
                    accusamus repudiandae voluptate obcaecati, recusandae nostrum, inventore optio maxime eveniet
                    aliquid itaque qui doloribus molestias ipsum?
                </div>
