    ...
    <div class="container-fluid p-0">
        <div style="position: relative; display: flex; justify-content: center; align-items: center; height: 100vh;">
            ...
            <div style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; display: flex; flex-direction: column; justify-content: center; align-items: center; color: white; font-size: 20px;">
                ...
                <p>SURABAYA</p>
                <div class="nav-link login-link-border" style="display: flex; align-items: center; margin-top: 20px;">
                  <a href="https://maps.app.goo.gl/Yqg63hdZKrj4XgCQA" style="text-decoration: none; color: #fff; display: flex; align-items: center;">
                    <img src="img/maps.png" alt="Maps Logo" style="width: 30px; height: 30px; margin-right: 10px;">
                    <span>Maps</span>
                  </a>
                </div>
            </div>
