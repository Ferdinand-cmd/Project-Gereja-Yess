...
<body>
    ...
    <main class="main-content">
        <section class="main-title">
            <button class="btn-back" onclick="goBackToAturKomsel()"><span class="material-icons"
        ...
        <section class="card mb-4">
            <div class="card-title">Sabtu, 6 April 2024 &nbsp &nbsp
                <button class="action-icon modal-counter-box edit-event-button" data-bs-toggle="modal"
                    data-bs-target="#editEventModal"
                    style="display: block; background-color:#eeb120; float: right; ">mode_edit</button>

                <button class="action-icon" class="modal-counter-box "
                    style="display: block; background-color:#eeb120; float: right; ">delete</button>
            </div>
            </div>
                    ...
                    <div class="col mb-3">
                        <div class="user-input-box">
                            ...
                            <input type="text" class="form-control"id="namaEvent" name="namaEvent"
                                style="border-radius: 0; border-color: #939393;" required>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col ">
                        <div class="user-input-box">
                            ...
                            <input type="text" class="form-control"id="namaEvent" name="lokasi"
                                style="border-radius: 0; border-color: #939393;" required>
                        </div>
                    </div>
                </div>
        ...
        <!-- form edit -->
        <div class="modal fade modal-lg edit-event-modal" id="editEventModal" tabindex="-1"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-cancel float-start"
