...
<body style="background-color:black;">
    ...
    <div class="container">
      <div>
        ...
        <div class="content" style="position: relative; z-index: 0; text-align: center;">
            <div class="container-fluid p-0">
                <div style="position: relative; display: flex; justify-content: center; align-items: center; height: 68vh;">
                    <img src="img/home ladies pic.png" alt="" class="w-100" style="position: absolute; top: 0; left: 0; height: 410px; object-fit: cover; left: 0; top: 0;">
            ...
            <div class="column-2">
              <div class="div-6">
                <div class="div">
                  <div class="column-3">
                    <img
                      src="img/kegiatan 1.png"
                      class="img-1"
                    />
                  </div>
                  <div class="column-4">
                    <img
                      src="img/kegiatan 2.png"
                      class="img-2"
                    />
                  </div>
                </div>
      ...
      <!--JADWAL IBADAH-->
      <div class="jadwal">
        <span class="jadwal-kebaktian-ladies-devotion"
          >JADWAL KEBAKTIAN <br/>    LADIES DEVOTION
        </span>
        <div class="flex-row-c">
          <div class="ibadah-onsite-background">
            <span class="ibadah-onsite">IBADAH ONSITE</span
            ><span class="setiap-senin-ciputra-world"
              ><br />SETIAP SENIN (MINGGU KE-1 DAN KE-3)<br />CIPUTRA WORLD LANTAI
              2 || JAM 18.00 WIB</span
            >
          </div>
          <div class="ibadah-online-background">
            <div class="image"></div>
            <span class="ibadah-online">IBADAH ONLINE</span
            ><span class="setiap-jumat-live"
              ><br />SETIAP JU’MAT || 10.30 WIB<br />LIVE ON YOUTUBE</span
            >
          </div>
          ...
          <div class="columnupe-2">
            <div class="divupe-2">
              ...
              <div class="divupe-7">
                ...
                <img
                  src="https://cdn.builder.io/api/v1/image/assets/TEMP/7f6f38dfafac6de01110ea9df97aa85852fb122659f3f42100348f7c20665b92?"
                  class="imgupe-2"
                />
              </div>
            </div>
