...
<head>
    ...
    <title>YESS.SUB | Penjadwalan YESS Kebutuhan (Admin)</title>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editModalLabel">EDIT DETAIL IBADAH YESS</h5>
    ...
    <div class="container">
        <section class="wrapper">
            <main class="main-content">
                <div>
                    <a href="penjadwalan-yess-admin.blade.php" class="arrow-link">
                        <button class="arrow-btn">
                            <span class="material-icons">arrow_back</span>
                        </button>
                    </a>
                    <h2 class="section-header">Pelayanan YESS - Ciputra World</h2>
                </div>
                <div class="main-content-2">
                    <div class="sub-header">
                        <div class="date">Sabtu, 6 April 2024</div>
