...
<head>
    ...
    <title>YESS.SUB | Penjadwalan Worship Night (Admin)</title>
...
<body>
    ...
    <!-- Modal kebutuhan -->
    <div class="modal modal-kebutuhan fade" id="kebutuhanModal" tabindex="-1" aria-labelledby="kebutuhanLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="kebutuhanLabel">Form Detail Ibadah Worship Night 5 April 2024</h5>
                    ...
                    <div class="field-group">
                        <div class="mb-3">
                            <div class="row g-3 align-items-center">
                                <div class="col-auto">
                                    <input type="number" id="usher" placeholder="Jumlah" class="form-control"
                                        required>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="mb-3">
                            <div class="row g-3 align-items-center">
                                <div class="col-auto">
                                    <input type="number" id="wl" placeholder="Jumlah" class="form-control"
                                        required>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="mb-3">
                            <div class="row g-3 align-items-center">
                                <div class="col-auto">
                                    <input type="number" id="singer" placeholder="Jumlah" class="form-control"
                                        required>
                                </div>
                                <div class="col-auto">
                ...
                <div class="modal-footer">
                    ...
                    <a href="penjadwalan-night-kebutuhan-admin.blade.php" class="arrow-link">
        ...
        <div class="wrapper">
            <main class="section-container">
                <div>
                    ...
                    <h2 class="section-header">Worship Night - Ciputra World</h2>
                </div>
                                ...
                                <table class="table table-borderless">
                                    <thead>
                                        <tr class="table-dark">
                                            ...
                                            <th scope="col">Detail ibadah worship night</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
            ...
            switchElement.addEventListener('change', function() {
                ...
                if (switchElement.checked) {
                    ...
                    if (!arrowButton) {
                        ...
                        newButton.setAttribute('data-bs-target',
                        '#kebutuhanModal'); // Replace '#kebutuhanModal' with wanted modal ID
                        newButton.innerHTML =
