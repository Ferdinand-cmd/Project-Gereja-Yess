  ...
  @media (max-width: 991px) {
    .select-field {
      padding-right: 20px;
        ...
        .modal-add-titik .modal-body,
        .modal-edit-titik .modal-body {
            background-color: #000;
        }

        .modal-add-titik .form-label,
        .modal-edit-titik .form-label {
            color: #fff;
            font: 24px Kanit, sans-serif;
        }
...
<body>
    ...
    <!-- Modal Penjemput -->
    <div class="modal modal-lg modal-penjemput fade" id="penjemputModal" tabindex="-1"
        aria-labelledby="penjemputModalLabel" aria-hidden="true">
                        ...
                        <table class="table table-striped table-bordered border-secondary">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-select" required>
                                            <option value="Hotel Dafam Pacific Caesar" selected>Hotel Dafam Pacific
                                                Caesar</option>
                                            <option value="Pakuwon Trade Center Lobby A&W">Pakuwon Trade Center Lobby
                                                A&W</option>
                                        </select>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-select" required>
                                            <option value="Hotel Dafam Pacific Caesar">Hotel Dafam Pacific Caesar
                                            </option>
                                            <option value="Pakuwon Trade Center Lobby A&W" selected>Pakuwon Trade
                                                Center Lobby A&W</option>
                                        </select>
                                    </td>
                                </tr>
                            </tbody>
    ...
    <div class="modal modal-add-titik fade" id="addTitikModal" tabindex="-1" aria-labelledby="addTitikModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="mb-3">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="date" class="form-control" id="aTTitik" name="aTTitik" required>
                            </div>
                            <div class="col">
    ...
    <div class="modal modal-edit-titik fade" id="editTitikModal" tabindex="-1"
        aria-labelledby="editTitikModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div class="mb-3">
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="date" class="form-control" id="eTTitik" name="eTTitik" required>
                            </div>
                            <div class="col">
