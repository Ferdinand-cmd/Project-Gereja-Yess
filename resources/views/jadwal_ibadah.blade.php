...
<body>
    ...
    <div class="div">
        <div class="fotoAwal">
            <img loading="lazy" srcset="img/jadwal/expecting.png" class="img" />
            <div class="expecting">
                We’re
                <br>
                expecting
        ...
        <div class="contInfoWorship">
            <img loading="lazy" srcset="img/jadwal/worship.png" class="img-3" />
        ...
        <div class="yessUmum">
            ...
            <div class="space">
                <div class="contYESS">
                    <div class="columnImgYESS">
                        <img loading="lazy" srcset="img/jadwal/yess.png" class="img-4" />
                    </div>
                    <div class="columninfoYESS">
                        <div class="contInfoYESS">
                            ...
                            <a href="https://www.google.com/maps/dir//yess+best+church/data=!4m6!4m5!1m1!4e2!1m2!1m1!1s0x2dd7fd60f866f4a3:0x2143b72c2c5c982e?sa=X&ved=1t:3061&ictx=111"
                                class="map button1"><span>DAPATKAN ARAH</span></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="lokasiUmum"><span style="color:#265BA4; font-weight: bold;">Ciputra World</span> - <span
                    style="color:#ff4949; font-weight: bold;">Pondok Tjandra</span> - <span
                    style="color:#EEB120; font-weight: bold;">Dafam</span></div>
            <div class="space2">
                <div class="contCard">
                    ...
                    <div class="columnCard">
                        <div class="container">
                            <div class="card">
                                <div class="front">
                                    <img loading="lazy" srcset="img/jadwal/cw.png" class="img-7" />
                                </div>
                                <div class="back">
                                    <img loading="lazy" srcset="img/jadwal/cw.png" class="img-back" />
                                    <div class = "contInformasiIbadah">
                                        ...
                                        <span
                                            style="background-color:#265BA4; color: white;border-bottom-left-radius: 30px;border-bottom-right-radius: 30px;">Ciputra
                                            World Surabaya 2nd floor Jl. Mayjend Sungkono No. 89</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="columnCard">
                        <div class="container">
                            <div class="card">
                                <div class="front">
                                    <img loading="lazy" srcset="img/jadwal/pok.png" class="img-7" />
                                </div>
                                <div class="back">
                                    <img loading="lazy" srcset="img/jadwal/pok.png" class="img-back" />
                                    <div class = "contInformasiIbadah">
                                        <ul>
                                            <li>Ibadah 1 - 10.30 WIB<br> topik(kalo ada)<br> Rubin Ong</li>
                                            <li>Ibadah 2 - 10.30 WIB<br> topik(kalo ada)<br> Rubin Ong</li>
                                        ...
                                        <span
                                            style="background-color:#ff4949; color: white;border-bottom-left-radius: 30px;border-bottom-right-radius: 30px;">Pondok
                                            Tjandra Indah Sports Club Jl. Taman Asri Selatan No. 48 </span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="columnCard">
                        <div class="container">
                            <div class="card">
                                <div class="front">
                                    <img loading="lazy" srcset="img/jadwal/dafam.png" class="img-7" />
                                </div>
                                <div class="back">
                                    <img loading="lazy" srcset="img/jadwal/dafam.png" class="img-back" />
                                    <div class = "contInformasiIbadah">
                                        <ul>
                                            <li>Ibadah 1 - 10.30 WIB<br> topik(kalo ada)<br> Rubin Ong</li>
                                            <li>Ibadah 2 - 10.30 WIB<br> topik(kalo ada)<br> Rubin Ong</li>
                                        ...
                                        <span
                                            style="background-color:#EEB120; color: black;  border-bottom-left-radius: 30px;border-bottom-right-radius: 30px;">Hotel
                                            Dafam Jl. Dr. Ir. H. Soekarno No. 45-C</span>
                                    </div>
                                </div>
                            </div>
                        </div>
